...
class Crawler:
    ...
    def crawl(self, url):
        try:
            ...
            if response.status_code == 200:
                ...
                count = self.contar_ocorrencias(cleaned_text, self.keyword)
                if count > 0:
                    self.results.append({'url': url, 'texto_limpo': cleaned_text, 'ocorrencias': count})
    ...
    def contar_ocorrencias(self, texto, palavra):
